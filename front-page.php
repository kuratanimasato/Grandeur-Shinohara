                ...
                <div class="features__wrap">
                    <div class="features__box">
                        <div class="features__box-item">
                            <picture>
                                <source media="(max-width: 767px)"
                                    srcset="<?php echo get_template_directory_uri() ?>/assets/images/schedule-sp.webp"
                                    type="image/webp">
                                <source media="(max-width: 767px)"
                                    srcset="<?php echo get_template_directory_uri() ?>/assets/images/schedule-sp.jpg"
                                    type="image/jpeg">
                                <source srcset="<?php echo get_template_directory_uri() ?>/assets/images/schedule.webp"
                                    type="image/webp">
                                <img class="features-img"
                                    src="<?php echo get_template_directory_uri() ?>/assets/images/schedule.jpg"
                        ...
                        <div class="features__box-item">
                            <picture>
                                <source media="(max-width: 767px)"
                                    srcset="<?php echo get_template_directory_uri() ?>/assets/images/shopping-sp.webp"
                                    type="image/webp">
                                <source media="(max-width: 767px)"
                                    srcset="<?php echo get_template_directory_uri() ?>/assets/images/shopping-sp.jpeg"
                                    type="image/jpeg">

                                <source srcset="<?php echo get_template_directory_uri() ?>/assets/images/shopping.webp"
                                    type="image/webp">
                                <img class="features-img"
                                    src="<?php echo get_template_directory_uri() ?>/assets/images/shopping.jpeg"
                        ...
                        <div class="features__box-item">
                            <picture>
                                <source media="(max-width: 767px)"
                                    srcset="<?php echo get_template_directory_uri() ?>/assets/images/renovation-sp.webp"
                                    type="image/webp">
                                <source media="(max-width: 767px)"
                                    srcset="<?php echo get_template_directory_uri() ?>/assets/images/renovation-sp.jpeg"
                                    type="image/jpeg">

                                <source
                                    srcset="<?php echo get_template_directory_uri() ?>/assets/images/renovation.webp"
                                    type="image/webp">
                                <img class="features-img"
                                    src="<?php echo get_template_directory_uri() ?>/assets/images/renovation.jpeg"
